...
const Home = () => {
  ...
  return (
    <div>
      ...
      <Apropos homePageStats={homePageStats} />
    </div>
  )
}

const Apropos = ({ homePageStats }) => {
    ...
    <div className='a-propos'>
      ...
      <Row>
        <Col xs={12} md={6}>
          <p>
            ...
            agricole, l’État Togolais, à travers le ministre du développement à
      ...
      <Row className='mt-3'>
        <Col>
          ...
          <p>
            Fort des résultats intéressants enregistrés par le projet, la revue
            à mi-parcours du projet réalisée en décembre 2018 a recommandé de
            rendre visibles et accessibles ces résultats aux parties prenantes
            du projet via un système d’information géographique. Ce qui
            nécessite la mise en place d’un système d’information géographique.
            En vue de mettre en place un système d’information géographique du
            projet, l’UGP veut réaliser une étude de géolocalisation des
          ...
          <p>
            ...
            moyennes industries (PMI) et des micro-entreprises accompagnées par
            le PAEIJ-SP en relevant leurs coordonnées GPS, en les photographiant
            et en collectant des informations relatives à leurs activités. Il
            s’agira de faire un géo référencement des réalisations du projet.
            Notons que le géoréférencement, selon Wikipédia, est le processus
            dans lequel on applique à une entité cartographique un emplacement
            spatial en lui donnant des coordonnées géographiques et en
            appliquant une transformation. C’est une action qui consiste à
            relier un objet et les données, les géo-références, qui y sont
      ...
      <Row className='mt-3'>
        <Col>
          <p className='text-center'>
            Nombre de bénéficiaires par composante ayant effectivement participé
            à la collecte pour le géoréférencement
          </p>
        </Col>
      </Row>
      {loading ? (
          ...
          <Col sm={12} md={6} lg={3}>
            <Card className='shadow border-0 mb-3 text-center'>
              <Card.Body>
                ...
                <span style={{ fontSize: "2.5rem", fontWeight: "bold" }}>
                  {stats.nbByComposante.Groupement.toFixed(0)}
                </span>
                <p className='m-0 text-uppercase' style={{ color: "#ffce1a" }}>
                  Groupement
                </p>
          ...
          <Col sm={12} md={6} lg={3}>
            <Card className='shadow border-0 mb-3 text-center'>
              <Card.Body>
                ...
                <span style={{ fontSize: "2.5rem", fontWeight: "bold" }}>
                  {stats.nbByComposante.Primo.toFixed(0)}
                </span>
                <p className='m-0 text-uppercase' style={{ color: "#ffce1a" }}>
                  Primo
                </p>
      ...
      <Row className='mt-3'>
        <Col sm={12} md={6} lg={6}>
          ...
          <Table striped bordered hover>
            ...
            <tbody>
              {/* {Object.keys(stats.repBenByCompReg).map(item=>(
								<tr key={item}>
									<td>{}</td>
								</tr>
							))} */}
